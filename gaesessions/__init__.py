...
from settings import COOKIE_PARENT_DOMAIN
...
COOKIE_NAME_PREFIX = "GS"  # identifies a cookie as being one used by gae-sessions (so you can set cookies too)
COOKIE_PATH = "/"
...
# else:
#     COOKIE_FMT = ' ' + COOKIE_NAME_PREFIX + '%02d="%s"; Domain=' + COOKIE_PARENT_DOMAIN + '; %sPath=' + COOKIE_PATH + '; HttpOnly'
EXPIRE_COOKIE_FMT = ' %s=; expires=Wed, 01-Jan-1970 00:00:00 GMT; Path=' + COOKIE_PATH
COOKIE_FMT = ' ' + COOKIE_NAME_PREFIX + '%02d="%s"; %sPath=' + COOKIE_PATH + '; HttpOnly'
