from models import Session, LoginCode
from application.models.user import User
from settings import SESSION_EXPIRY
import uuid
import os
import datetime
import time
...
LIFETIME = datetime.timedelta(hours=SESSION_EXPIRY)
...
class SessionHandler(object):
    ...
    def login(self):
        ...
        expires += datetime.timedelta(hours=SESSION_EXPIRY)
        ...
        self.sess.start(
            expiration_ts=time.mktime((datetime.datetime.now() + LIFETIME).timetuple()))
